...
public class GuitarESP extends InstrumentsBase {
    public GuitarESP(String name, String type) {
        super(name, type);
    }
    ...
    public void tuning(String string) {
        ...
        System.out.printf("Turn the string from 1 to 7 %n");
        string = in.nextLine();
        switch (string){
            case "1":
            ...
            case "4":
                ...
                break;
            case "5":
                System.out.printf("'A' note is sound %n");
                break;
            case "6":
                System.out.printf("'E' note is sound %n");
                break;
            case "7":
                System.out.printf("'F' note is sound %n");
                break;
            default:
